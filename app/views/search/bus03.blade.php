		...
		<table class="tabla_itinerario" id="id_tabla_itinerario" cellpadding="0" cellspacing="0">  
	  		<tbody>
		  		...
		  		<tr class="celda">
				    ...
				    <td class="info_dinamica"><strong><%vm.option_departure.departure_time%></strong></td>
				    <td class="info_dinamica"><%vm.departure_airport.city%></td>
				    <td class="info_dinamica"><strong><%vm.option_departure.arrival_time%></strong> <strong></strong></td>
				    <td class="info_dinamica"><%vm.arrival_airport.city%></td>
				    <td class="info_dinamica"><br>
		      		<br>Operado por Wan Peru   </td>
		  		...
		  		<tr class="celda">
		    		<td class="info_dinamica">Domingo 24 mayo 2015&nbsp;</td>
				    <td class="info_dinamica"><strong><%vm.option_return.departure_time%></strong></td>
				    <td class="info_dinamica"><%vm.arrival_airport.city%></td>
				    <td class="info_dinamica"><strong><%vm.option_return.arrival_time%></strong> <strong></strong></td>
				    <td class="info_dinamica"><%vm.departure_airport.city%></td>
				    <td class="info_dinamica"><br>
		      		<br>Operado por Wan Peru   </td>
		    		<td class="info_dinamica">Económica-V
						...
						<table id="qa_tabla_tarifa" class="tabla_tarifa" cellpadding="0" cellspacing="0">
	    					<tbody>
	    						...
	    						<tr class="no-par celda_pasajero"> 
									<td class="celda_tp"><%vm.passengers%> x Pasajero adulto</td>
									<td class="costo"></td>
									<td class="costo"><%vm.passenger_price| currency:"USD$":2%></td>
									<td class="costo"><%vm.taxes| currency:"USD$":2%></td>	
									<td class="costo"></td>
								</tr>
						    	<tr class="cabezera"> 
					...
					<div id="CCFee">
						...
						<table class="table" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								<tr>
									<td>
										<select id="otra_moneda" ng-model="vm.tipo_moneda" ng-change="vm.changeCurrency()">
											<option value="">Selecciona</option>
											<option value="1">Dólares (USD)</option>
											<option value="2">Euros (EUR)</option>
											<option value="3">nuevos soles (PEN)</option>
											<option value="4">pesos argentinos (ARS)</option>
											<option value="5">pesos chilenos (CLP)</option>
											<option value="6">Reales brasileños (BRL)</option>
											<option value="7">Dólares Canadienses (CAD)</option>
											<option value="8">pesos colombianos (COP)</option>
										</select>
									</td>
								</tr>
								<tr>
